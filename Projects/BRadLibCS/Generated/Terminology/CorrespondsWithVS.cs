...
namespace BreastRadLib
{
	public class CorrespondsWithVS
	{
		...
		public static TCoding Code_Cprofilern = new TCoding(CorrespondsWithCS.Code_Cprofilern);                                                   // CSItemValueSet.cs:73
		...
		{                                                                                                                                         // CSItemValueSet.cs:59
		    ...
		    yield return Code_Cprofilern;                                                                                                         // CSItemValueSet.cs:84
