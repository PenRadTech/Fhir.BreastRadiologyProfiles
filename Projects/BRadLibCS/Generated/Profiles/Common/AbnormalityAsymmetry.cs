...
namespace BRadLibCS
{
	...
	{
		ObservationComponentItem<CodeableConcept> AsymmetryType { get; set; }                                                                     // CSComponentSlice.cs:106
	...
	public partial class AbnormalityAsymmetryProfile :  ObservationBase, IAbnormalityAsymmetry
	{
		...
		public ObservationComponentItem<CodeableConcept> AsymmetryType { get; set; }                                                              // CSComponentSlice.cs:106
		...
		/// </summary>
		public AbnormalityAsymmetryProfile(BreastRadiologyDocument doc) : base(doc)
		{
		    this.Init();
		}
			...
			{                                                                                                                                        // CSComponentSlice.cs:137
			    ...
			    {                                                                                                                                    // FhirConstruct.cs:761
			        ...
			        {                                                                                                                                // FhirConstruct.cs:771
			            ...
			            temp4.CodeElement.Value = "abnormalityAsymmetryType";                                                                        // FhirConstruct.cs:793
			            retVal.Coding.Add(temp4);                                                                                                    // FhirConstruct.cs:820
			        }                                                                                                                                // FhirConstruct.cs:821
			        return retVal;                                                                                                                   // FhirConstruct.cs:836
			    }                                                                                                                                    // FhirConstruct.cs:837
			    this.AsymmetryType = new ObservationComponentItem<CodeableConcept>(ObservationCode());                                               // CSComponentSlice.cs:146
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			this.AsymmetryType.Validate(sb);                                                                                                         // CSPropertyBase.cs:45
			return retVal;
		}
		...
		public override void Write()
		{
			...
			this.AsymmetryType.Write(this.Doc, this.Resource);                                                                                       // CSPropertyBase.cs:39
		}
		...
		public override void Read()
		{
			...
			this.AsymmetryType.Read(this.Doc, this.Resource);                                                                                        // CSPropertyBase.cs:33
		}
