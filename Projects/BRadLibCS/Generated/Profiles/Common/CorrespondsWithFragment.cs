...
using 	BreastRadLib.NCorrespondsWithFragment;
...
namespace BreastRadLib
{
	...
	public interface ICorrespondsWithFragment 
	{
		...
		/// </summary>
		NCorrespondsWithFragment.CorrespondsWith.Component CorrespondsWith { get; set; }
		                                                                                                                                          // CSItemFragment.cs:131

	}


	namespace NCorrespondsWithFragment
	{
		namespace CorrespondsWith
