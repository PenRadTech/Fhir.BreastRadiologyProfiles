...
namespace BRadLibCS
{
	...
	{
		ObservationComponentItem<CodeableConcept> CorrespondsWith { get; set; }                                                                   // CSComponentSlice.cs:105
	}
	...
	public static class CorrespondsWithFragmentExtensions
	{
		...
		{                                                                                                                                         // CSComponentSlice.cs:136
		    ...
		    fragment.CorrespondsWith = new ObservationComponentItem<CodeableConcept>(ObservationCode());                                          // CSComponentSlice.cs:145
