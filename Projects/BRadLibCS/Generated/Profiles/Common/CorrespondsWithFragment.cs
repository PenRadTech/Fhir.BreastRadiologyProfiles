...
namespace BRadLibCS
{
	...
	{
		Component<CodeableConcept> CorrespondsWith { get; set; }                                                                                  // CSComponentSlice.cs:100
	}
	...
	public static class CorrespondsWithFragmentExtensions
	{
		...
		{                                                                                                                                         // CSComponentSlice.cs:123
		    ...
		    fragment.CorrespondsWith = new Component<CodeableConcept>(ObservationCode());                                                         // CSComponentSlice.cs:131
