...
namespace BRadLibCS
{
	...
	{
		ObservationComponentItem<CodeableConcept> CorrespondsWith { get; set; }                                                                   // CSComponentSlice.cs:106
	}
	...
	public static class CorrespondsWithFragmentExtensions
	{
		...
		public static void Init(this ICorrespondsWithFragment fragment)
		{
		{                                                                                                                                         // CSComponentSlice.cs:137
		    ...
		    fragment.CorrespondsWith = new ObservationComponentItem<CodeableConcept>(ObservationCode());                                          // CSComponentSlice.cs:146
		}                                                                                                                                         // CSComponentSlice.cs:154
		}

		public static void Read(this ICorrespondsWithFragment fragment, BreastRadiologyDocument doc)
		{
		}

		public static void Write(this ICorrespondsWithFragment fragment, BreastRadiologyDocument doc)
		{
		}
