...
using 	BreastRadLib.NObservedCountFragment;
...
namespace BreastRadLib
{
	...
	public interface IObservedCountFragment 
	{
		...
		/// </summary>
		NObservedCountFragment.ObservedCount.Component ObservedCount { get; set; }
		                                                                                                                                          // CSItemFragment.cs:146

	}


	namespace NObservedCountFragment
	{
		namespace ObservedCount
