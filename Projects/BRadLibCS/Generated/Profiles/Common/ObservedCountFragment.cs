...
namespace BRadLibCS
{
	...
	{
		ObservationComponentItem<Base, Quantity,Range> ObservedCount { get; set; }                                                                // CSComponentSlice.cs:106
	}
	...
	public static class ObservedCountFragmentExtensions
	{
		...
		{                                                                                                                                         // CSComponentSlice.cs:137
		    ...
		    fragment.ObservedCount = new ObservationComponentItem<Base, Quantity,Range>(ObservationCode());                                       // CSComponentSlice.cs:146
