...
namespace BRadLibCS
{
	...
	{
		ObservationComponentItem<Quantity,Range> ObservedCount { get; set; }                                                                      // CSComponentSlice.cs:96
	}
	...
	public static class ObservedCountFragmentExtensions
	{
		...
		{                                                                                                                                         // CSComponentSlice.cs:127
		    ...
		    fragment.ObservedCount = new ObservationComponentItem<Quantity,Range>(ObservationCode());                                             // CSComponentSlice.cs:136
