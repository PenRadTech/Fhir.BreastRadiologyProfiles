...
namespace BRadLibCS
{
	...
	{
		ObservationComponentItem<CodeableConcept> PrevDemBy { get; set; }                                                                         // CSComponentSlice.cs:100
	}
	...
	public static class PreviouslyDemonstratedByFragmentExtensions
	{
		...
		{                                                                                                                                         // CSComponentSlice.cs:123
		    ...
		    fragment.PrevDemBy = new ObservationComponentItem<CodeableConcept>(ObservationCode());                                                // CSComponentSlice.cs:131
