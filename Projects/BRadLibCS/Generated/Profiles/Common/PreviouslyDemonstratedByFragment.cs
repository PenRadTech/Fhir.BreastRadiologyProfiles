...
namespace BRadLibCS
{
	...
	{
		ObservationComponentItem<CodeableConcept> PrevDemBy { get; set; }                                                                         // CSComponentSlice.cs:106
	}
	...
	public static class PreviouslyDemonstratedByFragmentExtensions
	{
		...
		{                                                                                                                                         // CSComponentSlice.cs:137
		    ...
		    fragment.PrevDemBy = new ObservationComponentItem<CodeableConcept>(ObservationCode());                                                // CSComponentSlice.cs:146
		}                                                                                                                                         // CSComponentSlice.cs:154
		}

		public static void Read(this IPreviouslyDemonstratedByFragment fragment, BreastRadiologyDocument doc)
		{
		}

		public static void Write(this IPreviouslyDemonstratedByFragment fragment, BreastRadiologyDocument doc)
		{
		}
