...
namespace BRadLibCS
{
	...
	{
		ObservationComponentItem<CodeableConcept> PrevDemBy { get; set; }                                                                         // CSComponentSlice.cs:96
	}
	...
	public static class PreviouslyDemonstratedByFragmentExtensions
	{
		...
		{                                                                                                                                         // CSComponentSlice.cs:127
		    ...
		    fragment.PrevDemBy = new ObservationComponentItem<CodeableConcept>(ObservationCode());                                                // CSComponentSlice.cs:136
