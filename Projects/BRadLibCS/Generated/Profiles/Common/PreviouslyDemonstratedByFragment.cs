...
using 	BreastRadLib.NPreviouslyDemonstratedByFragment;
...
namespace BreastRadLib
{
	...
	public interface IPreviouslyDemonstratedByFragment 
	{
		...
		/// </summary>
		NPreviouslyDemonstratedByFragment.PrevDemBy.Component PrevDemBy { get; set; }
		                                                                                                                                          // CSItemFragment.cs:146

	}


	namespace NPreviouslyDemonstratedByFragment
	{
		namespace PrevDemBy
