...
namespace BRadLibCS
{
	...
	{
		Component<CodeableConcept> PrevDemBy { get; set; }                                                                                        // CSComponentSlice.cs:100
	}
	...
	public static class PreviouslyDemonstratedByFragmentExtensions
	{
		...
		{                                                                                                                                         // CSComponentSlice.cs:123
		    ...
		    fragment.PrevDemBy = new Component<CodeableConcept>(ObservationCode());                                                               // CSComponentSlice.cs:131
