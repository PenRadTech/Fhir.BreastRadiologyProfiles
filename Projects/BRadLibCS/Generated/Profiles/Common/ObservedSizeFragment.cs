...
namespace BRadLibCS
{
	...
	{
		ObservationComponentItem<Quantity,Range> ObsSize { get; set; }                                                                            // CSComponentSlice.cs:96
	}
	...
	public static class ObservedSizeFragmentExtensions
	{
		...
		{                                                                                                                                         // CSComponentSlice.cs:127
		    ...
		    fragment.ObsSize = new ObservationComponentItem<Quantity,Range>(ObservationCode());                                                   // CSComponentSlice.cs:136
