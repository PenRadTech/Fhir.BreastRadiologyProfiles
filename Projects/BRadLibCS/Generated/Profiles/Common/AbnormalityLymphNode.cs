...
namespace BRadLibCS
{
	...
	{
		ObservationComponentItem<CodeableConcept> LymphNodeType { get; set; }                                                                     // CSComponentSlice.cs:106
	...
	public partial class AbnormalityLymphNodeProfile :  ObservationBase, IAbnormalityLymphNode
	{
		...
		public ObservationComponentItem<CodeableConcept> LymphNodeType { get; set; }                                                              // CSComponentSlice.cs:106
		...
		/// </summary>
		public AbnormalityLymphNodeProfile(BreastRadiologyDocument doc) : base(doc)
		{
		    this.Init();
		}
		...
		protected override void Init()
		{
			...
			{                                                                                                                                        // CSComponentSlice.cs:137
			    ...
			    this.LymphNodeType = new ObservationComponentItem<CodeableConcept>(ObservationCode());                                               // CSComponentSlice.cs:146
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			this.LymphNodeType.Validate(sb);                                                                                                         // CSPropertyBase.cs:45
			return retVal;
		}
		...
		public override void Write()
		{
			...
			this.LymphNodeType.Write(this.Doc, this.Resource);                                                                                       // CSPropertyBase.cs:39
		}
		...
		public override void Read()
		{
			...
			this.LymphNodeType.Read(this.Doc, this.Resource);                                                                                        // CSPropertyBase.cs:33
		}
