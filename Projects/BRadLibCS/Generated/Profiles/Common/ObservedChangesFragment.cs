...
using 	BreastRadLib.NObservedChangesFragment;
...
namespace BreastRadLib
{
	...
	public interface IObservedChangesFragment 
	{
		...
		/// </summary>
		NObservedChangesFragment.ObsChanges.Component ObsChanges { get; set; }
		                                                                                                                                          // CSItemFragment.cs:131

	}


	namespace NObservedChangesFragment
	{
		namespace ObsChanges
