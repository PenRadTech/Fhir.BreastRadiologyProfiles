...
namespace BRadLibCS
{
	...
	{
		Component<CodeableConcept> BiRadsAssessmentCategory { get; set; }                                                                         // CSComponentSlice.cs:100
	}
	...
	public static class BiRadFragmentExtensions
	{
		...
		{                                                                                                                                         // CSComponentSlice.cs:123
		    ...
		    fragment.BiRadsAssessmentCategory = new Component<CodeableConcept>(ObservationCode());                                                // CSComponentSlice.cs:131
