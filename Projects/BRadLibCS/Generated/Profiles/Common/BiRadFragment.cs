...
using 	BreastRadLib.NBiRadFragment;
...
namespace BreastRadLib
{
	...
	public interface IBiRadFragment 
	{
		...
		/// </summary>
		NBiRadFragment.BiRadsAssessmentCategory.Component BiRadsAssessmentCategory { get; set; }
		                                                                                                                                          // CSItemFragment.cs:131

	}


	namespace NBiRadFragment
	{
		namespace BiRadsAssessmentCategory
