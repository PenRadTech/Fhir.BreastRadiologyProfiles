...
namespace BRadLibCS
{
	...
	{
		Component<CodeableConcept> ConsistentWith { get; set; }                                                                                   // CSComponentSlice.cs:100
		Component<CodeableConcept> Qualifier { get; set; }                                                                                        // CSComponentSlice.cs:100
	...
	{
		public Component<CodeableConcept> ConsistentWith { get; set; }                                                                            // CSComponentSlice.cs:100
		public Component<CodeableConcept> Qualifier { get; set; }                                                                                 // CSComponentSlice.cs:100
