...
namespace BRadLibCS
{
	...
	public static class ObservedDistributionFragmentExtensions
	{
		...
		{                                                                                                                                         // CSComponentSlice.cs:119
		    ...
		    fragment.ObsDistribution = new ObservationComponentItem<CodeableConcept>(ObservationCode());                                          // CSComponentSlice.cs:128
		...
		{                                                                                                                                         // CSComponentSlice.cs:119
		    ...
		    fragment.ObsDistRegionSize = new ObservationComponentItem<Quantity,Range>(ObservationCode());                                         // CSComponentSlice.cs:128
		}                                                                                                                                         // CSComponentSlice.cs:136
		}
