...
namespace BRadLibCS
{
	...
	{
		Component<CodeableConcept> ObsDistribution { get; set; }                                                                                  // CSComponentSlice.cs:100
		Component<Quantity,Range> ObsDistRegionSize { get; set; }                                                                                 // CSComponentSlice.cs:100
	}
	...
	public static class ObservedDistributionFragmentExtensions
	{
		...
		{                                                                                                                                         // CSComponentSlice.cs:123
		    ...
		    fragment.ObsDistribution = new Component<CodeableConcept>(ObservationCode());                                                         // CSComponentSlice.cs:131
		...
		{                                                                                                                                         // CSComponentSlice.cs:123
		    ...
		    fragment.ObsDistRegionSize = new Component<Quantity,Range>(ObservationCode());                                                        // CSComponentSlice.cs:131
		}                                                                                                                                         // CSComponentSlice.cs:139
		}
