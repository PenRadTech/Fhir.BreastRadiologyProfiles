...
namespace BRadLibCS
{
	...
	{
		ObservationComponentItem<CodeableConcept> ObsDistribution { get; set; }                                                                   // CSComponentSlice.cs:100
		ObservationComponentItem<Quantity,Range> ObsDistRegionSize { get; set; }                                                                  // CSComponentSlice.cs:100
	}
	...
	public static class ObservedDistributionFragmentExtensions
	{
		...
		{                                                                                                                                         // CSComponentSlice.cs:123
		    ...
		    fragment.ObsDistribution = new ObservationComponentItem<CodeableConcept>(ObservationCode());                                          // CSComponentSlice.cs:131
		...
		{                                                                                                                                         // CSComponentSlice.cs:123
		    ...
		    fragment.ObsDistRegionSize = new ObservationComponentItem<Quantity,Range>(ObservationCode());                                         // CSComponentSlice.cs:131
		}                                                                                                                                         // CSComponentSlice.cs:139
		}
