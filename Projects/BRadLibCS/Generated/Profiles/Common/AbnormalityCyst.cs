...
namespace BRadLibCS
{
	...
	/// </summary>
	public partial class AbnormalityCyst :  ObservationBase, IAbnormalityCyst
	{
		...
		public HasMemberCollection<TumorSatellite> TumorSatellite { get; set; }                                                                   // CSPropMatchHasMemberSlice.cs:126
		...
		public override void Init(BreastRadiologyDocument doc, Base baseResource = null)
		{
			...
			((ITumorSatelliteFragment)this).Init(doc, baseResource);                                                                                 // CSItemClass.cs:73
		}
		...
		public override bool Validate(StringBuilder sb)
		{
			...
			((ITumorSatelliteFragment)this).Validate();                                                                                              // CSItemClass.cs:82
			return retVal;
		}
		...
		public override void Write()
		{
			...
			((ITumorSatelliteFragment)this).Write();                                                                                                 // CSItemClass.cs:79
		}
		...
		public override void Read()
		{
			...
			((ITumorSatelliteFragment)this).Read();                                                                                                  // CSItemClass.cs:76
		}
