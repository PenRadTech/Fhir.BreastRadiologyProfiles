...
namespace BRadLibCS
{
	...
	{
		ObservationComponentItem<CodeableConcept> MassType { get; set; }                                                                          // CSComponentSlice.cs:105
	...
	public partial class AbnormalityMassProfile :  ObservationBase, IAbnormalityMass
	{
		...
		public ObservationComponentItem<CodeableConcept> MassType { get; set; }                                                                   // CSComponentSlice.cs:105
		...
		protected override void Init()
		{
			...
			{                                                                                                                                        // CSComponentSlice.cs:136
			    ...
			    this.MassType = new ObservationComponentItem<CodeableConcept>(ObservationCode());                                                    // CSComponentSlice.cs:145
