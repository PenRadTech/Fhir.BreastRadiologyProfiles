...
using 	BreastRadLib.NNotPreviouslySeenFragment;
...
namespace BreastRadLib
{
	...
	public interface INotPreviouslySeenFragment 
	{
		...
		/// </summary>
		NNotPreviouslySeenFragment.NotPreviouslySeen.Component NotPreviouslySeen { get; set; }
		                                                                                                                                          // CSItemFragment.cs:131

	}


	namespace NNotPreviouslySeenFragment
	{
		namespace NotPreviouslySeen
