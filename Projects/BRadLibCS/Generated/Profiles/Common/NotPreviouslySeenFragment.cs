...
namespace BRadLibCS
{
	...
	{
		Component<CodeableConcept> NotPreviouslySeen { get; set; }                                                                                // CSComponentSlice.cs:100
	}
	...
	public static class NotPreviouslySeenFragmentExtensions
	{
		...
		{                                                                                                                                         // CSComponentSlice.cs:123
		    ...
		    fragment.NotPreviouslySeen = new Component<CodeableConcept>(ObservationCode());                                                       // CSComponentSlice.cs:131
