...
namespace BRadLibCS
{
	...
	{
		ObservationComponentItem<CodeableConcept> NotPreviouslySeen { get; set; }                                                                 // CSComponentSlice.cs:105
	}
	...
	public static class NotPreviouslySeenFragmentExtensions
	{
		...
		{                                                                                                                                         // CSComponentSlice.cs:136
		    ...
		    fragment.NotPreviouslySeen = new ObservationComponentItem<CodeableConcept>(ObservationCode());                                        // CSComponentSlice.cs:145
