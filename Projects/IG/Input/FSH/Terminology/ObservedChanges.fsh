...
Description: "Observed changes in an abnormality code system."
  ...
  * #IncreaseInCalcifications "Increase in calcifications"
    """
    There is an increase in the number of calcifications associated with the item being observed. This increase is from the previous observation of this item.
    """

  * #IncreaseInNumber "Increase in number"
    """
    There is an increase in the number of items being observed. This increase is from the previous observation of this item.
    """

  * #IncreaseInSize "Increase in size"
    """
    The item being observed has increased in size. This increase is from the previous observation of this item.
    """

  * #LessProminent "Less prominent"
    """
    The item being observed has decreased in prominance. This decrease is from the previous observation of this item.
    """

  * #MoreProminent "More prominent"
    """
    The item being observed has increased in prominance. This increase is from the previous observation of this item.
    """
  ...
  * #NoLongerSeen "No longer seen"
    """
    The item being observed is no longer visible. It was visible on previous observations.
    """

  * #NotSignificantChanged "Not significant changed"
    """
    The item being observed has not significantly changed since
    the last Mammogram.
    """
