Profile: MGAbnormalityArchitecturalDistortion
Parent: Observation
...
Description: """
  ...
  * code 1..1
  * code = ObservationCodesCS#mgAbnormalityArchitecturalDistortionObservation
...
PreviouslyDemonstratedByVS valueset.  
  ...
  * component[prevDemBy].value[x] from PreviouslyDemonstratedByVS
  ...
  //#apply Graph.LinkByName("focus", "^MGAbnormalityArchitecturalDistortion/$", "^MGAbnormalityArchitecturalDistortion/hasMember/$", "0")
