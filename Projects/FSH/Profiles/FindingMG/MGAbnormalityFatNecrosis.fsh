Profile: MGAbnormalityFatNecrosis
Parent: Observation
...
Description: """
  ...
  * code 1..1
  * code = ObservationCodesCS#mgAbnormalityFatNecrosisObservation
...
PreviouslyDemonstratedByVS valueset.  
  ...
  * component[prevDemBy].value[x] from PreviouslyDemonstratedByVS
  ...
  //#apply Graph.LinkByName("focus", "^MGAbnormalityFatNecrosis/$", "^MGAbnormalityFatNecrosis/hasMember/$", "0")
